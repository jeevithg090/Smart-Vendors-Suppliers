...
export default function VendorDashboard() {
  ...
  // Enhanced Search Tab (Algolia-powered)
  if (activeTab === 'enhancedSearch') {
    return (
      <PageLayout>
        <div className="max-w-7xl mx-auto p-6">
          <div className="mb-6">
          ...
          {displayVendorStats && displayVendorStats.totalOrders > 0 && (
            <div className="mb-8">
              ...
              <div className="grid md:grid-cols-4 gap-4">
                ...
                <div className="bg-gray-50 p-4 rounded-lg text-center">
                  <div className="text-2xl font-bold text-gray-800 mb-1">
                    {displayVendorStats.completedOrders}
                  </div>
                  <div className="text-sm text-gray-600">Completed Orders</div>
                </div>

                {displayVendorStats.averageRating > 0 && (
                  <div className="bg-gray-50 p-4 rounded-lg text-center">
                    <div className="text-2xl font-bold text-gray-800 mb-1 flex items-center justify-center">
                      {displayVendorStats.averageRating.toFixed(1)}
                ...
                {displayVendorStats.onTimeDeliveryRate > 0 && (
                  <div className="bg-gray-50 p-4 rounded-lg text-center">
                    <div className="text-2xl font-bold text-gray-800 mb-1">
                      {Math.round(displayVendorStats.onTimeDeliveryRate)}%
                    </div>
